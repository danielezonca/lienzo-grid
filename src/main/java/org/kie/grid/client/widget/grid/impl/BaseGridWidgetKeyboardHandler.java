...
import org.kie.grid.client.widget.grid.impl.KeyboardOperation.TriStateBoolean;
...
public class BaseGridWidgetKeyboardHandler implements KeyDownHandler {
    ...
    private boolean keyDownStateMatches(final boolean actualKeyDownState,
                                        final KeyboardOperation.TriStateBoolean requiredKeyDownState) {
        ...
        if (!actualKeyDownState && (requiredKeyDownState == KeyboardOperation.TriStateBoolean.FALSE || requiredKeyDownState == KeyboardOperation.TriStateBoolean.DONT_CARE)) {
            return true;
        }
        return false;
    }
