 ...
 */
package org.kie.grid.client.model.impl;
...
import org.kie.grid.client.model.GridRow;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertFalse;
import static org.kie.grid.client.model.impl.BaseGridTest.Expected.build;
    ...
    public void testGroupOverlap_CollapseBlockWithinParent() {
        ...
        assertGridIndexes(gridData,
                          ...
                          new BaseGridTest.Expected[][]{
                                  {Expected.build(true,
                                                  5,
                                                  "g1"), Expected.build(false,
                                                                        1,
                                                                        "(1, 0)")},
                                  {Expected.build(true,
                                                  0,
                                                  "g1"), Expected.build(true,
                                                                        3,
                                                                        "g2")},
                                  {Expected.build(true,
                                                  0,
    ...
    public void testGroupOverlap_CollapseRightColumn_SingleCellOverlap_SplitBlock() {
        ...
        assertGridIndexes(gridData,
                          ...
                          new BaseGridTest.Expected[][]{
                                  {Expected.build(false,
                                                  1,
                                                  "(0, 0)"), Expected.build(true,
                                                                            3,
                                                                            "g2")},
                                  {Expected.build(false,
                                                  1,
                                                  "(0, 1)"), Expected.build(true,
                                                                            0,
                                                                            "g2")},
                                  {Expected.build(false,
                                                  1,
    ...
    public void testGroupOverlap_CollapseLeftColumn_SingleCellOverlap_SplitBlock() {
        ...
        assertGridIndexes(gridData,
                          ...
                          new BaseGridTest.Expected[][]{
                                  ...
                                  {Expected.build(false,
                                                  1,
                                                  "(0, 3)"), Expected.build(true,
                                                                            2,
                                                                            "g2")},
                                  {Expected.build(false,
                                                  1,
                                                  "(0, 4)"), Expected.build(true,
                                                                            0,
                                                                            "g2")}
                          });
